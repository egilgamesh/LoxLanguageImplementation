...
public class parser2
{
	...
	public parser2(List<Token> tokens, ErrorHandler errorHandler)
	{
		this.tokens = tokens;
	...
	private Expression Primary()
	{
		...
		if (MatchAny(TokenType.Number, TokenType.String)) return new Expression.Literal(Previous().literal);
